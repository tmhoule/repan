    ...
    <Card className="bg-zinc-900 border-zinc-800 h-full">
      ...
      <CardContent className="pb-4">
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-lg bg-zinc-800/60 border border-zinc-700/50 p-3 flex flex-col gap-1">
            <span className="text-xs text-zinc-500 uppercase tracking-wider">Items</span>
            <span className="text-2xl font-bold text-zinc-100 tabular-nums">{totalItems}</span>
          </div>
          <div className="rounded-lg bg-zinc-800/60 border border-zinc-700/50 p-3 flex flex-col gap-1">
            <span className="text-xs text-zinc-500 uppercase tracking-wider">Effort pts</span>
            <span className="text-2xl font-bold text-zinc-100 tabular-nums">{totalEffort}</span>
          </div>
          <div className="rounded-lg bg-zinc-800/60 border border-zinc-700/50 p-3 flex flex-col gap-1">
            <span className="text-xs text-zinc-500 uppercase tracking-wider">Est. runway</span>
